...
export const NICHE_DEFINITIONS: NicheDefinition[] = [
  ...
  },
  {
    ...
    iconName: 'Shirt',
    description: 'Sapatarias, tênis e calçados em geral',
    primaryTag: 'shop=shoes',
    overpassTags: ['shop=shoes'],
    synonyms: ['calcados', 'calçados', 'sapato', 'sapataria', 'tenis', 'sapatos', 'loja de calcados'],
  },
  {
    key: 'escola_idiomas',
    label: 'Escola de Idiomas / Cursos',
    iconName: 'Building',
    description: 'Escolas de idiomas e cursos livres',
    primaryTag: 'amenity=language_school',
    overpassTags: ['amenity=language_school'],
    synonyms: ['idiomas', 'ingles', 'inglês', 'espanhol', 'curso', 'escola de idiomas', 'lingua'],
  },
  {
    key: 'marmitaria',
